    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       m_id=jTextField1.getText();
        ...
        try{
           ...
           String query="Update Manager set m_fname='"+fname+"',m_lname='"+lname+"',m_age="+age+"where m_id="+m_id;
           ResultSet rs=stmt.executeQuery(query);
           dialogmessage=" Manager Updated!";
	   JOptionPane.showMessageDialog(null,dialogmessage,"Update Successsful",JOptionPane.INFORMATION_MESSAGE);	
